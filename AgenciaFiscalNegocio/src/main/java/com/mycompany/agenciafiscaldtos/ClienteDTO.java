...
/**
 * Clase que representa un objeto de transferencia de datos (DTO) para un cliente.
 * Contiene información sobre el cliente, como su RFC, nombre, apellidos, discapacidad, fecha de nacimiento y teléfono.
 * 
 * @author af_da
 */
